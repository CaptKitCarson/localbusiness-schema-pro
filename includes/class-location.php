...
class LSP_Location {
	...
	public static function business_types() {
		return array(
			'LocalBusiness'                => __( 'LocalBusiness (generic)', 'localbusiness-schema-pro' ),
			'ProfessionalService'          => __( 'ProfessionalService',      'localbusiness-schema-pro' ),
			'AutomotiveBusiness'           => __( 'AutomotiveBusiness',       'localbusiness-schema-pro' ),
			'Restaurant'                   => __( 'Restaurant',               'localbusiness-schema-pro' ),
			'CafeOrCoffeeShop'             => __( 'CafeOrCoffeeShop',         'localbusiness-schema-pro' ),
			'BarOrPub'                     => __( 'BarOrPub',                 'localbusiness-schema-pro' ),
			'FoodEstablishment'            => __( 'FoodEstablishment',        'localbusiness-schema-pro' ),
			'LodgingBusiness'              => __( 'LodgingBusiness',          'localbusiness-schema-pro' ),
			'Hotel'                        => __( 'Hotel',                    'localbusiness-schema-pro' ),
			'BedAndBreakfast'              => __( 'BedAndBreakfast',          'localbusiness-schema-pro' ),
			'Store'                        => __( 'Store',                    'localbusiness-schema-pro' ),
			'GroceryStore'                 => __( 'GroceryStore',             'localbusiness-schema-pro' ),
			'ClothingStore'                => __( 'ClothingStore',            'localbusiness-schema-pro' ),
			'HardwareStore'                => __( 'HardwareStore',            'localbusiness-schema-pro' ),
			'Attorney'                     => __( 'Attorney',                 'localbusiness-schema-pro' ),
			'Dentist'                      => __( 'Dentist',                  'localbusiness-schema-pro' ),
			'MedicalBusiness'              => __( 'MedicalBusiness',          'localbusiness-schema-pro' ),
			'HealthAndBeautyBusiness'      => __( 'HealthAndBeautyBusiness',  'localbusiness-schema-pro' ),
			'HairSalon'                    => __( 'HairSalon',                'localbusiness-schema-pro' ),
			'DaySpa'                       => __( 'DaySpa',                   'localbusiness-schema-pro' ),
			'HomeAndConstructionBusiness'  => __( 'HomeAndConstructionBusiness', 'localbusiness-schema-pro' ),
			'Plumber'                      => __( 'Plumber',                  'localbusiness-schema-pro' ),
			'Electrician'                  => __( 'Electrician',              'localbusiness-schema-pro' ),
			'HVACBusiness'                 => __( 'HVACBusiness',             'localbusiness-schema-pro' ),
			'RoofingContractor'            => __( 'RoofingContractor',        'localbusiness-schema-pro' ),
			'GeneralContractor'            => __( 'GeneralContractor',        'localbusiness-schema-pro' ),
			'MovingCompany'                => __( 'MovingCompany',            'localbusiness-schema-pro' ),
			'Locksmith'                    => __( 'Locksmith',                'localbusiness-schema-pro' ),
			'HousePainter'                 => __( 'HousePainter',             'localbusiness-schema-pro' ),
			'TravelAgency'                 => __( 'TravelAgency',             'localbusiness-schema-pro' ),
			'RealEstateAgent'              => __( 'RealEstateAgent',          'localbusiness-schema-pro' ),
			'SportsActivityLocation'       => __( 'SportsActivityLocation',   'localbusiness-schema-pro' ),
			'EmergencyService'             => __( 'EmergencyService',         'localbusiness-schema-pro' ),
			'FinancialService'             => __( 'FinancialService',         'localbusiness-schema-pro' ),
			'LegalService'                 => __( 'LegalService',             'localbusiness-schema-pro' ),
		);
	}
	...
	public function register_cpt() {
		$args = array(
			'label'               => __( 'Locations', 'localbusiness-schema-pro' ),
			'labels'              => array(
				'name'          => __( 'Locations', 'localbusiness-schema-pro' ),
				'singular_name' => __( 'Location',  'localbusiness-schema-pro' ),
				'add_new_item'  => __( 'Add Location', 'localbusiness-schema-pro' ),
				'edit_item'     => __( 'Edit Location', 'localbusiness-schema-pro' ),
				'menu_name'     => __( 'Locations', 'localbusiness-schema-pro' ),
				'search_items'  => __( 'Search Locations', 'localbusiness-schema-pro' ),
				'not_found'     => __( 'No locations yet.', 'localbusiness-schema-pro' ),
			),
			'public'              => false,
			'show_ui'             => true,
	...
	public function register_metabox() {
		add_meta_box(
			'lsp_location_meta',
			__( 'Location details', 'localbusiness-schema-pro' ),
